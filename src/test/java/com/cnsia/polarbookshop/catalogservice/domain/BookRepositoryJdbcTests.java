...
import com.cnsia.polarbookshop.catalogservice.config.DataConfig;
...
public class BookRepositoryJdbcTests {
    ...
    void findAllBooks() {
        ...
        assertThat(StreamSupport.stream(actualBooks.spliterator(), true)
                .filter((Book book) -> book.isbn().equals(book1.isbn()) || book.isbn().equals(book2.isbn()))
    ...
    @Test
    void existingByIsbnWhenNotExisting() {
